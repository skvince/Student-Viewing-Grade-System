...
<div class="tab-content" style="display: block;">
  ...
  <?php if ($flashPopupMessage): ?>
    <div class="alert alert-<?php echo htmlspecialchars($flashPopupMessageType); ?>" style="margin-bottom:24px;">
      <?php echo htmlspecialchars($flashPopupMessage); ?>
    </div>
  <?php endif; ?>
